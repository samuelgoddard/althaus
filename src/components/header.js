          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="ml-auto">
              <div className="flex flex-wrap items-center">
                ...
                <button className={this.props.color == 'black' ? `p-4 ml-3 text-purple` : `p-4 ml-3 text-white`}>
