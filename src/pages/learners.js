      ...
      <>
        ...
        >
          <motion.div variants={fade}>
                ...
                <div className="bg-purple-light">
                  <div className="container lg:px-32 pb-12">
                    ...
                    <div className="flex flex-wrap items-center bg-white p-4">
                      ...
                      <div className="w-full md:w-1/2 lg:w-1/4 border-b-2 md:border-0 lg:border-l-2 border-pink">
                        <AnchorLink to={`/learners/#find-an-apprenticeship`} title="Find An Apprenticeship" className="block text-lg text-purple text-center font-semibold px-4 py-6 md:py-8 hover:text-pink focus:text-pink">
            ...
            {/* Application Form */}
            <section className="pb-12 md:pb-8 lg:pb-8 xl:pb-24 -mt-24 md:-mt-32 lg:-mt-40 xl:-mt-64" id="find-an-apprenticeship">
